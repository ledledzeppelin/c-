...
namespace 餐厅管理系统.winForm
{
    public partial class FormShadow : Form
    {
        ...
        public FormShadow(Form master)
        {
            Owner = master; //设置主子窗口  
            master.BackColor = Color.White;
            master.StartPosition = FormStartPosition.CenterScreen;
            master.FormBorderStyle = FormBorderStyle.None;
            Button btnMin = new Button();
            Button btnCls = new Button();

            btnMin.Text = "\xe680";
            btnMin.Font = new Font(FormMultLogin.PFCC.Families[0], 13);
            btnMin.Size = new System.Drawing.Size(47, 47);
            btnMin.Location = new System.Drawing.Point(master.ClientSize.Width - btnMin.Width - 50, 5);
            btnMin.FlatStyle= FlatStyle.Flat;
            btnMin.FlatAppearance.BorderSize = 0;  // 设置按钮的边框宽度为0
            btnMin.Click += (e, s) =>
            {
                master.WindowState = FormWindowState.Minimized;
            };
            btnCls.Text = "\xe682";
            btnCls.Font = new Font(FormMultLogin.PFCC.Families[0], 13);
            btnCls.Size = new System.Drawing.Size(47, 47);
            btnCls.Location = new System.Drawing.Point(master.ClientSize.Width - btnCls.Width - 10, 5);
            btnCls.FlatStyle = FlatStyle.Flat;
            btnCls.FlatAppearance.BorderSize = 0;  // 设置按钮的边框宽度为0
            btnCls.Click += (e, s) =>
            {
                master.Close();
                if(master is FormAdmin)
                {
                    Application.Exit();
                }
            };
            master.Controls.Add(btnMin);
            master.Controls.Add(btnCls);
